...
newsletter = Newsletter(host='fedelaza.mysql.pythonanywhere-services.com', user='fedelaza', password='MyBase##', database='fedelaza$minewsletter')


# Carpeta para guardar las imagenes
#ruta_destino = 'static/img/'
ruta_destino = '/home/fedelaza/mysite/static/img/'
